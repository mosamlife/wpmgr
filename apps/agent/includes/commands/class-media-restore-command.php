...
final class MediaRestoreCommand implements CommandInterface
{
    ...
    /**
     * Effect: puts the archived original back and removes the optimized variant, and is a Write -- reverting
     * the site's live media to its pre-optimize state is the whole reason this command exists. The variant it
     * removes is derived and can be regenerated by media_optimize; that does not decide the label -- purpose
     * does. When the archived original is itself gone (original_deleted==1), restoreOne() refuses rather than
     * guess.
     *
