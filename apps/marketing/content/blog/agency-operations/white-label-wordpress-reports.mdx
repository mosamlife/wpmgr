...
**Backup status.** When the last successful backup ran, how often they run, and where they are stored. "Backed up daily to offsite storage" reassures people who could not define any of those terms, which is most clients.
