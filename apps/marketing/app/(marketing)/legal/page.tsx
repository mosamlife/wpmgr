...
const LEGAL_ITEMS = [
  {
    ...
    description:
      "Responsible disclosure scope and process, our security posture (Ed25519-signed agent, redacted diagnostics, backups stored by default in a control-plane-managed bucket, your own infrastructure if you self-host, WPMgr's on the hosted service, or in storage you configure yourself), and how to report a vulnerability.",
