...
func encodePauseSiteMonitoringRequest(
...
func encodePauseTenantAssistantRequest(
	req OptTenantAssistantPause,
	r *http.Request,
) error {
	const contentType = "application/json"
	if !req.Set {
...
func encodeResumeSiteMonitoringRequest(
...
func encodeSetMyInitialPasswordRequest(
