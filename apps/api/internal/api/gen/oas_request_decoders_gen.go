...
func (s *Server) decodePauseSiteMonitoringRequest(r *http.Request) (
	req *PauseMonitoringRequest,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request PauseMonitoringRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeResumeSiteMonitoringRequest(r *http.Request) (
	req *ResumeMonitoringRequest,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request ResumeMonitoringRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeSetMyInitialPasswordRequest(r *http.Request) (
	req *SetMyInitialPasswordReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request SetMyInitialPasswordReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
